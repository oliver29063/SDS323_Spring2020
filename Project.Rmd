...
```{r figurename, echo=FALSE, fig.cap="**Figure 1.** Schematic of Ag NCB.", out.width = '90%'}
...
```{r figurename, echo=FALSE, fig.cap="**Figure 2.** Table of extracted features.", out.width = '90%'}
...
```{r figurename, echo=FALSE, fig.cap="**Figure 3.** Feature selection process.", out.width = '90%'}
...
```{r figurename, echo=FALSE, fig.cap="**Figure 4.** Model performance based on number of features used.", out.width = '90%'}
